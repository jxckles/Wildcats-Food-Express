...
const ClientInterface = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get("https://wildcats-food-express-deploy2.vercel.app/orders");
  ...
  const handleAddToCart = async (item) => {
    try {
      ...
      const response = await axios.get(
        `https://wildcats-food-express-deploy2.vercel.app/menu/${item._id}/quantity`
      );
  ...
  const updateMenuItemQuantity = async (itemId, change) => {
    try {
      await axios.post("https://wildcats-food-express-deploy2.vercel.app/update-quantity", {
        itemId,
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      const response = await axios.post(
        "https://wildcats-food-express-deploy2.vercel.app/clientorders",
        order,
        {
          headers: {
